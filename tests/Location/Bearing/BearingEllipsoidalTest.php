...
class BearingEllipsoidalTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testIfCalculateBearingNorthEasternWorksAsExpected()
    {
        ...
        $this->assertEquals(45.0, $bearingCalculator->calculateBearing($point1, $point2), '', 0.2);
    }
    ...
    public function testIfCalculateBearingNorthWesternWorksAsExpected()
    {
        ...
        $this->assertEquals(315.0, $bearingCalculator->calculateBearing($point1, $point2), '', 0.2);
    }
    ...
    public function testIfCalculateBearingSouthEasternWorksAsExpected()
    {
        ...
        $this->assertEquals(135.0, $bearingCalculator->calculateBearing($point1, $point2), '', 0.2);
    }
    ...
    public function testIfCalculateBearingSouthWesternWorksAsExpected()
    {
        ...
        $this->assertEquals(225.0, $bearingCalculator->calculateBearing($point1, $point2), '', 0.2);
    }
